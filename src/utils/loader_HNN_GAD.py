...
def outlier_injection(args, data):  
    ...
    if args.outlier_type=='structural':
        ...
        data, y_outlier = gen_contextual_outliers(data, args.outlier_num, args.sample_size, args.outlier_seed)
        print('Generating contextual outliers', int(np.sum(y_outlier)))
        
    elif args.outlier_type=='dice':
        data, y_outlier = gen_dice_outliers(data, args.outlier_num, args.dice_ratio, None, args.outlier_seed)
        print('Generating dice outliers', int(np.sum(y_outlier)))
  
    elif args.outlier_type=='path':
        data, y_outlier = gen_path_outliers(data, args.outlier_num, args.sample_size, args.outlier_seed)
        ...
        data, y_outlier = gen_cont_struc_outliers(data, args.outlier_num, args.sample_size, args.struc_clique_size, clique_num, args.struc_drop_prob, args.outlier_seed)
        print('Generating contextual and structural outliers', int(np.sum(y_outlier)))  
        
    elif args.outlier_type=='path_dice':
        data, y_outlier = gen_path_dice_outliers(data, args.outlier_num, args.sample_size, args.dice_ratio, args.outlier_seed)
